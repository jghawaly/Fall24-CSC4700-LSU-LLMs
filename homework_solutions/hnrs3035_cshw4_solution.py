...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Run GPT-4o-mini and Llama 3.1 8B on Squad v2 dev set. Uses GPT-4o-mini for grading")
    parser.add_argument('--create_db', action='store_true', help="creates the Chroma database at the provided path")
    parser.add_argument('--db_path', type=str, default='../data/squad_db', help='path to where the database will be stored')
    ...
    if args.view_scores:
        ...
        # show the results
        print(f"RAG Llama 3.1 8B: {llama_correct_count} out of {llama_total_count}, or {llama_correct_count / llama_total_count:.2f}, questions answered correctly")
        print(f"RAG GPT-4o-mini:  {openai_correct_count} out of {openai_total_count}, or {openai_correct_count / openai_total_count:.2f}, questions answered correctly")
